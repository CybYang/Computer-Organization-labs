...
HD_PWD='D:/vivadoRepo/lab9-2/design_1_adpt_in2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adpt_in2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adpt_in2_0_0.tcl
