...
module design_1
  ...
  wire [7:0]adpt_in2_0_addr;
  wire adpt_in2_0_clk;
  wire [7:0]adpt_in2_0_data;
  wire adpt_in2_0_wren;
  wire [3:0]adpt_out2_0_seg_cs;
  wire [7:0]adpt_out2_0_seg_data;
  ...
  design_1_adpt_in2_0_0 adpt_in2_0
       (.addr(adpt_in2_0_addr),
        .btn_clk(cg_fpga_0_btn_clk),
        .clk(adpt_in2_0_clk),
        .data(adpt_in2_0_data),
        .sw_a(cg_fpga_0_gpio_sw_2),
        .sw_b(cg_fpga_0_gpio_sw_1),
        .wren(adpt_in2_0_wren));
  design_1_adpt_out2_0_0 adpt_out2_0
       (.clk_100M(cg_fpga_0_clk_100M),
        .data(ram_dp0_256x8_0_q),
        .seg_cs(adpt_out2_0_seg_cs),
        .seg_data(adpt_out2_0_seg_data));
  design_1_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_1_ram_dp0_256x8_0_0 ram_dp0_256x8_0
       (.address(adpt_in2_0_addr),
        .data(adpt_in2_0_data),
        .inclock(adpt_in2_0_clk),
        .q(ram_dp0_256x8_0_q),
        .wren(adpt_in2_0_wren));
endmodule
