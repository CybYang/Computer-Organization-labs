...
-- Date        : Mon Nov 17 11:45:38 2025
-- Host        : vj5PC52 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/coding_hong/lab10/lab10.gen/sources_1/bd/design_1/ip/design_1_adpt_out_0_0/design_1_adpt_out_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_adpt_out_0_0_adpt_out is
  ...
  attribute SOFT_HLUTNM of \scan_sel[3]_i_7\ : label is "soft_lutpair1";
begin
...
\scan_sel[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\scan_sel[3]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\seg_data[1]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^scan_sel_reg[3]_0\,
      I3 => \seg_data[6]_INST_0_i_3_n_0\,
      I4 => \seg_data[6]_INST_0_i_4_n_0\,
      I5 => \seg_data[6]_INST_0_i_2_n_0\,
      O => seg_data(1)
    );
\seg_data[2]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0202000200010000"
    )
        port map (
      I0 => \seg_data[6]_INST_0_i_1_n_0\,
      I1 => \^scan_sel_reg[2]_0\,
      ...
      I4 => \seg_data[6]_INST_0_i_4_n_0\,
      I5 => \seg_data[6]_INST_0_i_3_n_0\,
      O => seg_data(2)
    );
\seg_data[3]_INST_0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0300000200010100"
    )
        port map (
      I0 => \seg_data[6]_INST_0_i_1_n_0\,
      I1 => \^scan_sel_reg[2]_0\,
...
inst: entity work.design_1_adpt_out_0_0_adpt_out
     port map (
      clk_100M => clk_100M,
      digit0(7 downto 0) => digit0(7 downto 0),
      digit1(7 downto 0) => digit1(7 downto 0),
