...
module design_2
  ...
  wire [3:0]adpt_in4_modes_0_A;
  wire adpt_in4_modes_0_mode_and;
  wire adpt_in4_modes_0_mode_or;
  wire adpt_in4_modes_0_mode_xor;
  wire [3:0]adpt_in4_only_0_B;
  wire [31:0]cg_fpga_0_gpio_sw_1;
  wire [31:0]cg_fpga_0_gpio_sw_2;
  wire [31:0]logic4_to_led_0_led;

  design_2_adpt_in4_modes_0_0 adpt_in4_modes_0
       (.A(adpt_in4_modes_0_A),
        .mode_and(adpt_in4_modes_0_mode_and),
        .mode_or(adpt_in4_modes_0_mode_or),
        .mode_xor(adpt_in4_modes_0_mode_xor),
        .sw2(cg_fpga_0_gpio_sw_2));
  design_2_adpt_in4_only_0_0 adpt_in4_only_0
       (.B(adpt_in4_only_0_B),
        .sw1(cg_fpga_0_gpio_sw_1));
  design_2_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_2_logic4_to_led_0_0 logic4_to_led_0
       (.A(adpt_in4_modes_0_A),
        .B(adpt_in4_only_0_B),
        .led(logic4_to_led_0_led),
        .mode_and(adpt_in4_modes_0_mode_and),
        .mode_or(adpt_in4_modes_0_mode_or),
        .mode_xor(adpt_in4_modes_0_mode_xor));
endmodule
