...
#
# Script generated by Vivado on Mon Nov 10 11:53:00 +0800 2025
...
#
# Usage        : ram_dp0.sh
#                ram_dp0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_dp0.sh [-reset_run]
#                ram_dp0.sh [-reset_log]
#                ram_dp0.sh [-help]
#
...
# script info
echo -e "ram_dp0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_dp0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_dp0 xil_defaultlib.ram_dp0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_dp0 -key {Behavioral:sim_1:Functional:ram_dp0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_dp0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_dp0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_dp0.sh [-help]\n\
Usage: ram_dp0.sh [-step]\n\
Usage: ram_dp0.sh [-lib_map_path]\n\
Usage: ram_dp0.sh [-reset_run]\n\
Usage: ram_dp0.sh [-reset_log]\n\
Usage: ram_dp0.sh [-keep_index]\n\
Usage: ram_dp0.sh [-noclean_files]\n\n\
