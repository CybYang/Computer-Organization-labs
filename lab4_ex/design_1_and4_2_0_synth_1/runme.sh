...
HD_PWD='D:/vivadoRepo/lab4/design_1_and4_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_and4_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_and4_2_0.tcl
