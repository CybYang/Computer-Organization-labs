...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=30,numReposBlks=30,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=26,numPkgbdBlks=1,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  design_1_rom1_256x8_0_0 rom1_256x8_0
       (.address(ICR_0_Dout),
        ...
        .q(rom1_256x8_0_q));
  design_1_unpack4_0_0 unpack4_0
       (.din(rom1_256x8_0_q),
        .y0(unpack4_0_y0),
        .y1(unpack4_0_y1),
        .y2(unpack4_0_y2),
