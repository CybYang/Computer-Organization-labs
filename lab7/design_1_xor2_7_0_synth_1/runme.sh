...
HD_PWD='D:/vivadoRepo/lab7/design_1_xor2_7_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xor2_7_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xor2_7_0.tcl
