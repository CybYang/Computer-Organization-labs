...
HD_PWD='D:/vivadoRepo/lab7/design_1_FA_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FA_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FA_5_0.tcl
